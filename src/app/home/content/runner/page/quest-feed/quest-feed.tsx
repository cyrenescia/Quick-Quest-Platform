      ...
      <div className="grid gap-4 xl:grid-cols-2">
        {vm.quests.map((quest) => (
          <Surface key={quest.id} className="p-4 sm:p-5 border border-base-300/70">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              ...
              <span
                className={cn(
                  ...
                  quest.isAccessible === false
                    ? "bg-warning/10 text-warning"
                    : "bg-success/10 text-success",
                )}
              >
                {quest.questTier ?? "Q1"} / Score {quest.tierScore ?? 0}
              </span>
              <span className="rounded-[8px] bg-base-200 px-2 py-1 text-[11px] font-semibold text-base-content/70">
            ...
            <div
              className={cn(
                "mt-2 rounded-[10px] border px-3 py-2",
                quest.isAccessible === false
            ...
            >
              <p
                className={cn(
                  ...
                  quest.isAccessible === false ? "text-warning" : "text-success",
                )}
              >
                Akses Tier
              </p>
              <p className="mt-1 text-xs leading-relaxed text-base-content/70">
                {quest.accessibilityReason ||
                  `Runner ${quest.runnerTier ?? "Q1"} memenuhi akses quest ${quest.questTier ?? "Q1"}.`}
              </p>
            </div>
